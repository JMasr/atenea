...
# Laura: Lo he modificado para aplicar en VAD como hacen en Voxceleb.
...
## Set up features.
if $apply_cmn; then
  feats="ark,s,cs:apply-cmvn-sliding --norm-vars=false --center=true --cmn-window=300 scp:${sub_sdata}/JOB/feats.scp ark:- | select-voiced-frames ark:- scp,s,cs:${sdata}/vad.scp ark:- |"
else
  feats="ark,s,cs:select-voiced-frames scp:${sub_sdata}/JOB/feats.scp scp,s,cs:${sub_sdata}/JOB/vad.scp ark:- |"
fi
